...
function updateTableRow(fileName, fileData) {
    ...
    const status = activity_status === "Đang dừng" ? "🟡 Dừng hoạt động" :
                   ...
                   activity_status === "Cảnh báo" ? "🔴 Cảnh báo" : "Không rõ";

    const time_run = fileData["Thời gian chạy"] || "N/A";
    const time_stop = fileData["Thời gian dừng"] || "N/A";
    const time_alert = fileData["Thời gian cảnh báo"] || "N/A";
    const total_time_run = fileData["Tổng thời gian chạy"] || "N/A";
    const total_time_stop = fileData["Tổng thời gian dừng"] || "N/A";
    const total_time_alert = fileData["Tổng thời gian cảnh báo"] || "N/A";
